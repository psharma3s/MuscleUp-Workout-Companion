...
.flex-container {
display: flex;
justify-content: space-between; /* Add space between the calendar and registered classes */
...
/* Calendar Box */
.calendar-box {
width: 70%;  /* Calendar takes 70% of the width */
...
.registered-classes-section {
width: 30%;  /* Registered classes take 30% of the width */
...
margin-top: 20px;
overflow-y: auto;
height: 350px;  /* Fixed height to make the section scrollable */
}
